...
export default function ResultsScreen({ result, quiz, onPlayAgain, onBackToHome }: ResultsScreenProps) {
  const correctAnswers = result.answers.filter((a: any) => a.correct).length
  const incorrectAnswers = result.totalQuestions - correctAnswers
  const percentage = result.totalQuestions > 0 ? Math.round((correctAnswers / result.totalQuestions) * 100) : 0
  ...
  return (
      ...
      <div className="max-w-2xl mx-auto space-y-6 animate-slide-in bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
          ...
          <div className="text-5xl mb-4">
            ...
            {percentage >= 80 ? (
              ...
              <Lottie animationData={trophyAnimation} loop={false} className="w-48 h-48 mx-auto" />
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        ...
                        Your answer: <span className="font-bold">{answerIndex !== null ? question.options[answerIndex] : "Not answered"}</span>
