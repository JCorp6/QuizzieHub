...
import { getFirestore } from "firebase/firestore" // ⬅️ Perubahan: Import Firestore
...
  // databaseURL dihapus/diabaikan karena kita tidak menggunakan Realtime DB
...
export const db = getFirestore(app) // ⬅️ Perubahan: Mengekspor 'db' (Firestore)
